<template>
  <div class="bottom-tab">
    <span class="tab-item" @click="switchTo('/home')">
      <img
        :src="$route.path.includes('/home') ? this.tabBarImgArr[0].selected : this.tabBarImgArr[0].normal"
        alt
      />
    ...
    <span class="tab-item" @click="switchTo('/recommand')">
      <img
        :src="$route.path.includes('/recommand') ? this.tabBarImgArr[1].selected : this.tabBarImgArr[1].normal"
        alt
      />
      <span :class="{on:$route.path.includes('/recommand')}">推荐</span>
    </span>
    <span class="tab-item" @click="switchTo('/search')">
      <img
        :src="$route.path.includes('/search') ? this.tabBarImgArr[2].selected : this.tabBarImgArr[2].normal"
        alt
      />
    ...
    <span class="tab-item" @click="switchTo('/chat')">
      <img
        :src="$route.path.includes('/chat') ? this.tabBarImgArr[3].selected : this.tabBarImgArr[3].normal"
        alt
      />
    ...
    <span class="tab-item" @click="switchTo('/mine')">
      <img
        :src="$route.path.includes('/mine') ? this.tabBarImgArr[4].selected : this.tabBarImgArr[4].normal"
        alt
      />
